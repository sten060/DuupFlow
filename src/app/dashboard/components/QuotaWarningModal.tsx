  ...
  const content = (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-[var(--app-text)]">{t("dashboard.quotaWarn.title")}</h2>
        <p className="mt-3 text-sm leading-relaxed text-[var(--app-text-muted)] max-w-md mx-auto">{body}</p>
