...
/* ─── tiny helpers ─── */
const G = "bg-gradient-to-r from-indigo-400 via-fuchsia-400 to-pink-400 bg-clip-text text-transparent";
    ...
    <section className="relative flex flex-col items-center text-center px-6 pt-28 pb-24 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute top-20 right-1/4 w-[400px] h-[300px] rounded-full opacity-10"
          style={{ background: "radial-gradient(ellipse, #FF3FD1 0%, transparent 70%)" }} />
      </div>
    ...
    <section className="px-6 pb-28">
      <div className="max-w-5xl mx-auto">
        <div
          ...
          style={{ background: "linear-gradient(135deg, rgba(91,91,234,0.15) 0%, rgba(255,63,209,0.10) 100%)" }}
        >
    ...
    <footer className="px-6 pb-10 border-t border-white/[0.06]">
      <div className="max-w-5xl mx-auto pt-10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-sm font-bold tracking-tight">
          <span className="bg-gradient-to-r from-indigo-400 to-fuchsia-400 bg-clip-text text-transparent">Duup</span>
